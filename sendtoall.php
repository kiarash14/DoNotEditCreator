...
";
      ...
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>Do Not Edit Creator</b>
<b>ver. 3.0</b>
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://tg44333-tgmassenger.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://tg44333-tgmassenger.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://tg44333-tgmassenger.rhcloud.com/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=EditCreatorBot
...
define('WEBHOOK_URL', 'https://tg44333-tgmassenger.rhcloud.com/sendtoall.php');
